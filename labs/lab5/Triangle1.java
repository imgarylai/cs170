public class Triangle1 {
    public static void main(String[] args) {
         ...
         * XXXXXX   v <----> base = n
         * 
         * ++++ Note: the body of the for-loop uses the method indentCharLine()
         */
    }
    /*
     * ---------------------------------------------------------------
     ...
     * 
     * First, it prints i spaces (i.e., indents i positions) Then, it prints the
     * character c, n times. Finally, it prints NEWLINE (to start a new line)
     * ----------------------------------------------------------------
     */
